...
struct MPLPlotter <: Pseudospectra.PSAPlotter end
...
"""
function psa(::MPLPlotter, A::AbstractMatrix, opts::Dict{Symbol,Any}=Dict{Symbol,Any}())
...
function _portrait(::MPLPlotter, xs,ys,Z,eigA)
...
function et_cmap(; register=true)
    cm = [
