...

{
    ...
    "category": "section",
    "text": "It is customary to display pseudospectra as contour plots of the logarithm of the inverse of the resolvent norm epsilon = 1(A-zI)^-1 for z in a subset of the complex plane. Thus sigma_epsilon(A) is the union of the interiors of such contours. Such plots, sometimes called spectral portraits, are the most prominent product of this package.(Image: example figure)The figure shows a section of the complex plane with eigenvalues and contours of log10(ϵ). It was generated by the following code:using Plots, Pseudospectra, LinearAlgebra\nn=150\nB=diagm(1 => fill(2im,n-1), 2 => fill(-1,n-2), 3 => fill(2,n-3), -2 => fill(-4,n-2), -3 => fill(-2im, n-3))\nspectralportrait(B)"
},
